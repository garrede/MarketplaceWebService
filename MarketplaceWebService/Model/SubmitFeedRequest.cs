...
namespace MarketplaceWebService.Model
{
    ...
    public class SubmitFeedRequest
    {
        ...
        /// <summary>
        /// Gets and sets the FeedOptions property.
        /// </summary>
        [XmlElementAttribute(ElementName = "FeedOptions")]
        public String FeedOptions
        {
            get { return this.feedOptions ; }
            set { this.feedOptions= value; }
        }



        /// <summary>
        /// Sets the FeedOptions property
        /// </summary>
        /// <param name="feedOptions">FeedOptions property</param>
        /// <returns>this instance</returns>
